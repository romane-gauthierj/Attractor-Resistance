...
def get_patients(number_patients, drug_data, annotations_models, drug_interest, tissue_interest=None, tissue_remove=None):
    ...
    if tissue_remove is not None:
        ...
        annotations_models['tissue'] = annotations_models['tissue'].str.upper()
        annotations_models = annotations_models[annotations_models['tissue'] != tissue_remove]
    ...
    drug_tissue_data = pd.merge(drug_data, annotations_models_filtered, on='SANGER_MODEL_ID')
